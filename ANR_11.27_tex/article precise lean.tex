...
% 设置支持数学符号的等宽字体
\setmonofont{STIXTwoMath-Regular}

\lstdefinelanguage{Lean}{
    keywords={import, structure, def, theorem, lemma, instance, private, 
              noncomputable, irreducible, where, begin, end, by, rw, exact, 
              assume, have, show, fun, @, [, ], simp,
              intro, constructor, rfl, simp only, ext, cases, use, obtain, tauto, rintro, variable, subst, with, set, let, generalize_proofs, unfold, apply, left, right, open, simp_all, by_cases, exacts, congr, induction, contradiction, neg, negate_state, omega, ring, if, else, by_contra},
    morecomment=[l]{--},
    morecomment=[n]{/-}{-/},
    sensitive=true,
    alsoletter={@,[,]},  % 关键补充：将@[]视为合法字符
}
...
\lstset{
    ...
    tabsize=4,                       % 制表符大小
    morekeywords={import, structure, def, theorem, lemma, instance, private, noncomputable, irreducible, where, begin, end, by, rw, exact, assume, have, show,fun,@,[,simp,]},
    mathescape=true,
}
...
\begin{lstlisting}[language=Lean, firstnumber=1]
    import Mathlib
